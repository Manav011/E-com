            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-left">
                ...
                <div class="cellphone hidden-xs">
                  <p><span class="fa fa-phone"></span>+91 98578 24484</p>
                </div>
                <!-- / cellphone -->
              </div>
              <!-- / header top left -->
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="{{url('/')}}">
                  ...
                  <p>trend<strong>Box</strong> <span>Your Shopping Partner</span></p>
                </a>
                <!-- img based logo -->
              ...
              <div class="col-md-3 col-sm-6">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    <h3>Contact Us</h3>
                    <address>
                      <p> 25 astor CP, DELHI, 424514, India</p>
                      <p><span class="fa fa-phone"></span>+91 98578 24484</p>
                      <p><span class="fa fa-envelope"></span>trendbox@gmail.com</p>
                    </address>
      ...
      <div class="container">
        ...
        <div class="col-md-12">
          <div class="aa-footer-bottom-area">
            <p>Designed by <a href="http://manav.is-a.dev/" target="_blank">Manav Bafna</a></p>
