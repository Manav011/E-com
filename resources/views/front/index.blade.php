          ...
          <div class="aa-support-area">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="aa-support-single">
                ...
                <h4>FREE SHIPPING</h4>
                <P>Enjoy complimentary shipping on all orders—no minimum required, always free!</P>
              </div>
            </div>
            <!-- single support -->
            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="aa-support-single">
                ...
                <P>Risk-free shopping with a 30-day money-back guarantee on all purchases.</P>
              </div>
            </div>
            <!-- single support -->
            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="aa-support-single">
                ...
                <h4>SUPPORT 24/7</h4>
                <P>Get assistance anytime with our 24/7 customer support, always available.</P>
              </div>
            </div>
          </div>
        </div>
